...
export const MessageStore = {
  async create({ userId, messageSid, from, to, body, status, channel, direction, leadId }) {
    if (isMongoConnected()) {
      return await Message.create({ userId, messageSid, from, to, body, status: status || 'queued', channel, direction, leadId });
    }
